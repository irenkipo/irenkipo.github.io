...
- 2026-09-26 native counter production-sync repair: synchronize the already-approved 2026-09-25 native counter implementation from `src/assets/js/analytics.js` into the deployed root `assets/js/analytics.js` and allow the already-approved Google Forms transport in deployed homepage/reader CSP. This closes source-vs-production drift only; no visible copy, layout, artwork, typography, palette, controls, section order, or literary content changes.
