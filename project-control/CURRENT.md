...
- QA note: the visual-lock exception is branch-scoped only to this explicitly approved author-copy delta; HTML, SEO, security, responsive, download, and runtime checks remain mandatory.
